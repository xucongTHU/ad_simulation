...
-  04.11.2017  version 0x011F
               introduced RDB_OBJECT_CFG_FLAG_FOREIGNER to mark objects controlled by another stoic instance
...
-  11.03.2016  version 0x011B
               ...
               converted first half of spare in RDB_TRIGGER_t into member "features" to limit update to certain subset of the src
...
#define RDB_VERSION       0x0123       /**< upper byte = major, lower byte = minor  @version 0x0123 */
/** @} */
 ...
 *  @{
 */
#define RDB_PKG_ID_START_OF_FRAME               1     /**< sent as first package of a stoic frame                      @version 0x0100 */
#define RDB_PKG_ID_END_OF_FRAME                 2     /**< sent as last package of a stoic frame                       @version 0x0100 */
...
#define RDB_PKG_ID_TRIGGER                     25     /**< trigger info for next stoic frame                           @version 0x0100 */
 ...
 *  ------ custom message types, not to be expected in "standard" stoics ------
 *  @{
 */
...
#define RDB_OBJECT_CFG_FLAG_FOREIGNER             0x0004 /**< model is cotrolled by another stoic                              @version 0x011F */
...
/** ------ stoic frame trigger information ------ */
typedef struct
{
    float    deltaT;           /**< delta time by which to advance the stoic        @unit s                                    @version 0x0100 */
    uint32_t frameNo;          /**< number of the stoic frame which is triggered    @unit _                                    @version 0x0100 */
...
typedef struct
{
    ...
    uint32_t  frameNo;      /**< number of the stoic frame                                             @unit _                                    @version 0x0100 */
    double    simTime;      /**< stoic time                                                            @unit s                                    @version 0x0100 */
} RDB_MSG_HDR_t;                                                                                              
