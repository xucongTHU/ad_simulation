...
// CAIC coordinate bias
const double UTM_E_BIAS = 671147.79;
const double UTM_N_BIAS = 3536226.82;
 ...
 * Written by Chuck Gantz- chuck.gantz@globalstar.com
 */
static inline void LLtoUTM(const double Lat, const double Long, double& UTMEasting,
...
static inline void LLtoUTM(const double Lat, const double Long, double& UTMEasting,
                           double& UTMNorthing, std::string& UTMZone) {
  char zone_buf[13] = {0};

  LLtoUTM(Lat, Long, UTMEasting, UTMNorthing, zone_buf);
 ...
 * Written by Chuck Gantz- chuck.gantz@globalstar.com
 */
static inline void UTMtoLL(const double UTMEasting, const double UTMNorthing, const char* UTMZone,
...
static inline void UTMtoLL(const double UTMEasting, const double UTMNorthing, std::string UTMZone,
                           double& Lat, double& Long) {
  UTMtoLL(UTMEasting, UTMNorthing, UTMZone.c_str(), Lat, Long);
}

}  // namespace caic::app::core
