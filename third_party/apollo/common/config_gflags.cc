...
DEFINE_string(map_dir, "/smartsim/src/map/data/demo",
...
DEFINE_string(vehicle_config_path,
              "/smartsim/src/common/data/vehicle_param.pb.txt",
              "the file path of vehicle config file");

DEFINE_string(
    vehicle_model_config_filename,
    "/smartsim/src/common/vehicle_model/conf/vehicle_model_config.pb.txt",
...
DEFINE_string(
    ...
    "src/dreamview/conf/navigation_mode_default_end_way_point.txt",
