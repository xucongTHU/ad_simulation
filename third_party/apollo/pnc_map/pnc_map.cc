...
#include "third_party/smartsim/pnc_map/pnc_map.h"
#include "third_party/smartsim/hdmap/hdmap_util.h"
#include "third_party/smartsim/pnc_map/path.h"

#include "third_party/smartsim/proto/hdmap/map_id.pb.h"
#include "third_party/smartsim/common/point_factory.h"
...
using smartsim::common::VehicleState;
using smartsim::common::PointFactory;
using smartsim::routing::RoutingResponse;
...
#include "third_party/smartsim/common/util.h"
bool PncMap::IsNewRouting(const routing::RoutingResponse &prev,
  ...
  return !smartsim::common::IsProtoEqual(prev, routing);
}
