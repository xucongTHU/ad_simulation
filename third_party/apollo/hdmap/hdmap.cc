...
#include "third_party/smartsim/hdmap/hdmap.h"
#include "third_party/smartsim/hdmap/hdmap_util.h"
...
int HDMap::GetLanes(const smartsim::geometry::PointENU& point, double distance,
                    std::vector<LaneInfoConstPtr>* lanes) const {
  return impl_.GetLanes(point, distance, lanes);
}

int HDMap::GetJunctions(const smartsim::geometry::PointENU& point, double distance,
                        std::vector<JunctionInfoConstPtr>* junctions) const {
  return impl_.GetJunctions(point, distance, junctions);
}

int HDMap::GetSignals(const smartsim::geometry::PointENU& point, double distance,
                      std::vector<SignalInfoConstPtr>* signals) const {
  return impl_.GetSignals(point, distance, signals);
}

int HDMap::GetCrosswalks(const smartsim::geometry::PointENU& point, double distance,
                         std::vector<CrosswalkInfoConstPtr>* crosswalks) const {
  return impl_.GetCrosswalks(point, distance, crosswalks);
}

int HDMap::GetStopSigns(const smartsim::geometry::PointENU& point, double distance,
...
int HDMap::GetRoads(const smartsim::geometry::PointENU& point, double distance,
...
int HDMap::GetNearestLane(const smartsim::geometry::PointENU& point,
                          LaneInfoConstPtr* nearest_lane, double* nearest_s,
                          double* nearest_l) const {
  return impl_.GetNearestLane(point, nearest_lane, nearest_s, nearest_l);
}

int HDMap::GetNearestLaneWithHeading(const smartsim::geometry::PointENU& point,
...
int HDMap::GetLanesWithHeading(const smartsim::geometry::PointENU& point,
                               const double distance,
                               const double central_heading,
                               const double max_heading_difference,
                               std::vector<LaneInfoConstPtr>* lanes) const {
...
int HDMap::GetRoadBoundaries(
    const smartsim::geometry::PointENU& point, double radius,
...
int HDMap::GetRoi(const smartsim::geometry::PointENU& point, double radius,
...
int HDMap::GetLocalMap(const smartsim::geometry::PointENU& point,
                       const std::pair<double, double>& range,
                       Map* local_map) const {
  return impl_.GetLocalMap(point, range, local_map);
}

int HDMap::GetForwardNearestRSUs(const smartsim::geometry::PointENU& point,
...
bool HDMap::IsSuccessorLane(const std::string& cur_lane_id, 
  ...
  smartsim::hdmap::Id id;
  id.set_id(cur_lane_id);
  std::vector<smartsim::hdmap::LaneInfoConstPtr> lanes = GetPredecessorLanes(id);
