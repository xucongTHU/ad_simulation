...
#include "third_party/smartsim/math/aabox2d.h"
#include "third_party/smartsim/math/aaboxkdtree2d.h"
#include "third_party/smartsim/math/math_utils.h"
#include "third_party/smartsim/math/polygon2d.h"
#include "third_party/smartsim/math/vec2d.h"

#include "third_party/smartsim/proto/hdmap/map_clear_area.pb.h"
#include "third_party/smartsim/proto/hdmap/map_crosswalk.pb.h"
#include "third_party/smartsim/proto/hdmap/map_id.pb.h"
#include "third_party/smartsim/proto/hdmap/map_junction.pb.h"
#include "third_party/smartsim/proto/hdmap/map_lane.pb.h"
#include "third_party/smartsim/proto/hdmap/map_overlap.pb.h"
#include "third_party/smartsim/proto/hdmap/map_parking_space.pb.h"
#include "third_party/smartsim/proto/hdmap/map_pnc_junction.pb.h"
#include "third_party/smartsim/proto/hdmap/map_road.pb.h"
#include "third_party/smartsim/proto/hdmap/map_signal.pb.h"
#include "third_party/smartsim/proto/hdmap/map_speed_bump.pb.h"
#include "third_party/smartsim/proto/hdmap/map_stop_sign.pb.h"
#include "third_party/smartsim/proto/hdmap/map_yield_sign.pb.h"
#include "third_party/smartsim/proto/hdmap/map_rsu.pb.h"

/**
 * @namespace smartsim::hdmap
 * @brief smartsim::hdmap
 */
namespace smartsim {
namespace hdmap {
...
class ObjectWithAABox {
 public:
  ObjectWithAABox(const smartsim::math::AABox2d &aabox,
                  const Object *object, const GeoObject *geo_object,
                  const int id)
      : aabox_(aabox), object_(object), geo_object_(geo_object), id_(id) {}
  ~ObjectWithAABox() {}
  const smartsim::math::AABox2d &aabox() const { return aabox_; }
  double DistanceTo(const smartsim::math::Vec2d &point) const {
    return geo_object_->DistanceTo(point);
  }
  double DistanceSquareTo(const smartsim::math::Vec2d &point) const {
...
struct LineBoundary {
  std::vector<smartsim::geometry::PointENU> line_points;
};
struct PolygonBoundary {
  std::vector<smartsim::geometry::PointENU> polygon_points;
};
...
struct PolygonRoi {
  smartsim::math::Polygon2d polygon;
...
using LaneSegmentBox =
    ObjectWithAABox<LaneInfo, smartsim::math::LineSegment2d>;
using LaneSegmentKDTree = smartsim::math::AABoxKDTree2d<LaneSegmentBox>;
...
class LaneInfo {
 public:
  ...
  const std::vector<smartsim::math::Vec2d> &points() const {
    return points_;
  }
  const std::vector<smartsim::math::Vec2d> &unit_directions() const {
  ...
  const std::vector<smartsim::math::LineSegment2d> &segments() const {
    return segments_;
  }
  ...
  bool IsOnLane(const smartsim::math::Vec2d &point) const;
  bool IsOnLane(const smartsim::math::Box2d &box) const;

  smartsim::geometry::PointENU GetSmoothPoint(double s) const;
  double DistanceTo(const smartsim::math::Vec2d &point) const;
  double DistanceTo(const smartsim::math::Vec2d &point,
                    smartsim::math::Vec2d *map_point, double *s_offset,
                    int *s_offset_index) const;
  smartsim::geometry::PointENU GetNearestPoint(
      const smartsim::math::Vec2d &point, double *distance) const;
  bool GetProjection(const smartsim::math::Vec2d &point,
 ...
 private:
  const Lane &lane_;
  std::vector<smartsim::math::Vec2d> points_;
  std::vector<smartsim::math::Vec2d> unit_directions_;
  std::vector<double> headings_;
  std::vector<smartsim::math::LineSegment2d> segments_;
...
class JunctionInfo {
 public:
  ...
  const smartsim::math::Polygon2d &polygon() const { return polygon_; }
 ...
 private:
  ...
  smartsim::math::Polygon2d polygon_;

  std::vector<Id> overlap_stop_sign_ids_;
  std::vector<Id> overlap_ids_;
};
using JunctionPolygonBox =
    ObjectWithAABox<JunctionInfo, smartsim::math::Polygon2d>;
using JunctionPolygonKDTree =
    smartsim::math::AABoxKDTree2d<JunctionPolygonBox>;
...
using SignalSegmentBox =
    ObjectWithAABox<SignalInfo, smartsim::math::LineSegment2d>;
using SignalSegmentKDTree =
    smartsim::math::AABoxKDTree2d<SignalSegmentBox>;
...
using CrosswalkPolygonBox =
    ObjectWithAABox<CrosswalkInfo, smartsim::math::Polygon2d>;
using CrosswalkPolygonKDTree =
    smartsim::math::AABoxKDTree2d<CrosswalkPolygonBox>;
...
using StopSignSegmentBox =
    ObjectWithAABox<StopSignInfo, smartsim::math::LineSegment2d>;
using StopSignSegmentKDTree =
    smartsim::math::AABoxKDTree2d<StopSignSegmentBox>;
...
using YieldSignSegmentBox =
    ObjectWithAABox<YieldSignInfo, smartsim::math::LineSegment2d>;
using YieldSignSegmentKDTree =
    smartsim::math::AABoxKDTree2d<YieldSignSegmentBox>;
...
using ClearAreaPolygonBox =
    ObjectWithAABox<ClearAreaInfo, smartsim::math::Polygon2d>;
using ClearAreaPolygonKDTree =
    smartsim::math::AABoxKDTree2d<ClearAreaPolygonBox>;
...
using SpeedBumpSegmentBox =
    ObjectWithAABox<SpeedBumpInfo, smartsim::math::LineSegment2d>;
using SpeedBumpSegmentKDTree =
    smartsim::math::AABoxKDTree2d<SpeedBumpSegmentBox>;
...
class RoadInfo {
 public:
  ...
  smartsim::hdmap::Road_Type type() const { return road_.type(); }
...
using ParkingSpacePolygonBox =
    ObjectWithAABox<ParkingSpaceInfo, smartsim::math::Polygon2d>;
using ParkingSpacePolygonKDTree =
    smartsim::math::AABoxKDTree2d<ParkingSpacePolygonBox>;
...
using PNCJunctionPolygonBox =
    ObjectWithAABox<PNCJunctionInfo, smartsim::math::Polygon2d>;
using PNCJunctionPolygonKDTree =
    smartsim::math::AABoxKDTree2d<PNCJunctionPolygonBox>;
