...
PROJECT_NAME=${PROJECT_NAME:-"ad_simulation"}
TARGET_PALTFORM=${TARGET_PALTFORM:-"orin"}
...
cat > ${RELEASE_CONF} << EOF
{
  ...
  "AD_CROSS_COMPILE": "ON",
  "BT_CROSS_ROOT": "/usr/local/orin/",
  "BT_CROSS_TOOLCHAIN": "/usr/local/orin/aarch64--glibc--bleeding-edge-2024.02-1",
  "BT_SYSROOT": "/",
