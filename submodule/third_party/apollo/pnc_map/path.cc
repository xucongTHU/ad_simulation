...
using smartsim::math::Box2d;
using smartsim::math::kMathEpsilon;
using smartsim::math::LineSegment2d;
using smartsim::math::Sqr;
using smartsim::math::Vec2d;
// using smartsim::common::util::DebugStringFormatter;
