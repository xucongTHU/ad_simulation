...
#include "third_party/smartsim/math/line_segment2d.h"
#include "third_party/smartsim/math/polygon2d.h"
#include "third_party/smartsim/math/vec2d.h"
#include "third_party/smartsim/hdmap/hdmap_common.h"

#include "third_party/smartsim/proto/hdmap/map.pb.h"
#include "third_party/smartsim/proto/hdmap/map_clear_area.pb.h"
#include "third_party/smartsim/proto/hdmap/map_crosswalk.pb.h"
#include "third_party/smartsim/proto/hdmap/map_geometry.pb.h"
...
class HDMapImpl {
 ...
 public:
   ...
   * @return 0:success, otherwise failed
   */
  int GetLanes(const smartsim::geometry::PointENU& point, double distance,
   ...
   * @return 0:success, otherwise failed
   */
  int GetJunctions(const smartsim::geometry::PointENU& point, double distance,
   ...
   * @return 0:success, otherwise failed
   */
  int GetCrosswalks(const smartsim::geometry::PointENU& point, double distance,
   ...
   * @return 0:success, otherwise failed
   */
  int GetSignals(const smartsim::geometry::PointENU& point, double distance,
   ...
   * @return 0:success, otherwise failed
   */
  int GetStopSigns(const smartsim::geometry::PointENU& point, double distance,
   ...
   * @return 0:success, otherwise failed
   */
  int GetYieldSigns(const smartsim::geometry::PointENU& point, double distance,
   ...
   * @return 0:success, otherwise failed
   */
  int GetClearAreas(const smartsim::geometry::PointENU& point, double distance,
   ...
   * @return 0:success, otherwise failed
   */
  int GetSpeedBumps(const smartsim::geometry::PointENU& point, double distance,
   ...
   * @return 0:success, otherwise failed
   */
  int GetRoads(const smartsim::geometry::PointENU& point, double distance,
  ...
  int GetParkingSpaces(
      const smartsim::geometry::PointENU& point, double distance,
   ...
   * @return 0:success, otherwise, failed.
   */
  int GetNearestLane(const smartsim::geometry::PointENU& point,
   ...
   * @return 0:success, otherwise, failed.
   */
  int GetNearestLaneWithHeading(const smartsim::geometry::PointENU& point,
   ...
   * @return 0:success, otherwise, failed.
   */
  int GetLanesWithHeading(const smartsim::geometry::PointENU& point,
   ...
   * @return 0:success, otherwise failed
   */
  int GetRoadBoundaries(const smartsim::geometry::PointENU& point, double radius,
   ...
   * @return 0:success, otherwise failed
   */
  int GetRoi(const smartsim::geometry::PointENU& point, double radius,
  ...
  int GetForwardNearestSignalsOnLane(
      const smartsim::geometry::PointENU& point, const double distance,
      std::vector<SignalInfoConstPtr>* signals) const;
   ...
   * @return 0:success, otherwise failed
   */
  int GetLocalMap(const smartsim::geometry::PointENU& point,
   ...
   * @return 0:success, otherwise failed
   */
  int GetForwardNearestRSUs(const smartsim::geometry::PointENU& point,
                    double distance, double central_heading,
                    double max_heading_difference,
                    std::vector<RSUInfoConstPtr>* rsus) const;

 private:
  int GetLanes(const smartsim::math::Vec2d& point, double distance,
               std::vector<LaneInfoConstPtr>* lanes) const;
  int GetJunctions(const smartsim::math::Vec2d& point, double distance,
                   std::vector<JunctionInfoConstPtr>* junctions) const;
  int GetCrosswalks(const smartsim::math::Vec2d& point, double distance,
                    std::vector<CrosswalkInfoConstPtr>* crosswalks) const;
  int GetSignals(const smartsim::math::Vec2d& point, double distance,
                 std::vector<SignalInfoConstPtr>* signals) const;
  int GetStopSigns(const smartsim::math::Vec2d& point, double distance,
                   std::vector<StopSignInfoConstPtr>* stop_signs) const;
  int GetYieldSigns(const smartsim::math::Vec2d& point, double distance,
                    std::vector<YieldSignInfoConstPtr>* yield_signs) const;
  int GetClearAreas(const smartsim::math::Vec2d& point, double distance,
                    std::vector<ClearAreaInfoConstPtr>* clear_areas) const;
  int GetSpeedBumps(const smartsim::math::Vec2d& point, double distance,
                    std::vector<SpeedBumpInfoConstPtr>* speed_bumps) const;
  int GetParkingSpaces(
      const smartsim::math::Vec2d& point, double distance,
      std::vector<ParkingSpaceInfoConstPtr>* parking_spaces) const;
  int GetPNCJunctions(
      const smartsim::math::Vec2d& point, double distance,
      std::vector<PNCJunctionInfoConstPtr>* pnc_junctions) const;
  int GetNearestLane(const smartsim::math::Vec2d& point,
                     LaneInfoConstPtr* nearest_lane, double* nearest_s,
                     double* nearest_l) const;
  int GetNearestLaneWithHeading(const smartsim::math::Vec2d& point,
                                const double distance,
                                const double central_heading,
                                const double max_heading_difference,
                                LaneInfoConstPtr* nearest_lane,
                                double* nearest_s, double* nearest_l) const;
  int GetLanesWithHeading(const smartsim::math::Vec2d& point,
                          const double distance, const double central_heading,
                          const double max_heading_difference,
                          std::vector<LaneInfoConstPtr>* lanes) const;
  int GetRoads(const smartsim::math::Vec2d& point, double distance,
               std::vector<RoadInfoConstPtr>* roads) const;

  template <class Table, class BoxTable, class KDTree>
  static void BuildSegmentKDTree(
      const Table& table, const smartsim::math::AABoxKDTreeParams& params,
  ...
  static int SearchObjects(const smartsim::math::Vec2d& center,
