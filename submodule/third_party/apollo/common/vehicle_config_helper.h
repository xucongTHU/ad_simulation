...
#include "third_party/smartsim/proto/common/vehicle_config.pb.h"
#include "third_party/smartsim/proto/geometry/pnc_point.pb.h"
#include "third_party/smartsim/math/box2d.h"


/**
 * @namespace smartsim::common
 * @brief smartsim::common
 */
namespace smartsim {
namespace common {
 ...
 * defined src/common/configs/proto/vehicle_config.proto
 */
class VehicleConfigHelper {
 public:
  /**
   ...
   * defined by src/common/configs/proto/vehicle_config.proto.
   */
   ...
   * src/common/configs/proto/vehicle_config.proto.
   */
   ...
   */
  static smartsim::math::Box2d GetBoundingBox(
